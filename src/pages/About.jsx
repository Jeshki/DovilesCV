...
import { FaLanguage, FaGraduationCap, FaBriefcase, FaTools, FaUserCircle, FaBuilding, FaCalendarAlt } from 'react-icons/fa';

function About({ content }) {
    return (
        <div className="mt-10 max-w-4xl mx-auto px-4 mb-10">
            <h2 className="text-3xl md:text-4xl font-bold font-serif mb-8 text-center text-gray-900 dark:text-green-100 uppercase">
                {content.aboutTitle}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                ...
                <div className="md:col-span-1 flex flex-col items-center md:sticky md:top-24">
                    ...
                    <p className="text-gray-600 dark:text-green-300 mb-4">{content.title}</p> {/* Šviesesnė spalva */}
                </div>

                {/* Dešinė skiltis su žalios temos kortelėmis */}
                <div className="md:col-span-2 space-y-8">
                    ...
                    <div className="p-4 md:p-6 bg-white dark:bg-green-900 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-green-100">
                             <FaUserCircle className="mr-2 text-green-600 dark:text-green-400"/> Apie mane
                        </h3>
                    ...
                    <div className="p-4 md:p-6 bg-white dark:bg-green-900 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-green-100">
                            <FaTools className="mr-2 text-green-600 dark:text-green-400"/> {content.skillsTitle}
                        </h3>
                    ...
                    <div className="p-4 md:p-6 bg-white dark:bg-green-900 rounded-lg shadow">
                         <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-green-100">
                            <FaLanguage className="mr-2 text-green-600 dark:text-green-400"/> {content.languagesTitle}
                         </h3>
                     ...
                     <div className="p-4 md:p-6 bg-white dark:bg-green-900 rounded-lg shadow">
                          <h3 className="text-xl font-semibold mb-3 flex items-center text-gray-900 dark:text-green-100">
                            <FaGraduationCap className="mr-2 text-green-600 dark:text-green-400"/> {content.educationTitle}
                          </h3>
                     ...
                     <div className="p-4 md:p-6 bg-white dark:bg-green-900 rounded-lg shadow">
                        <h3 className="text-xl font-semibold mb-4 flex items-center text-gray-900 dark:text-green-100">
                            <FaBriefcase className="mr-2 text-green-600 dark:text-green-400"/> {content.experienceTitle}
                        </h3>
